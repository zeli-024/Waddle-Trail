...
This is a compiling functional scaffold. Configuration registration and server
storage-directory creation are active. The feature service classes intentionally
contain no unfinished behavior yet.
...
- `locator`: authoritative online and offline positions.
